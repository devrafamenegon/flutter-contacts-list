...
class ContactHelper {
  ...
  //esta classe possuí apenas um objeto (esse processo se chama SingleTow), para assim utilizar o mesmo banco de dados
  ...
  Future<Contact> getContact(int id) async {
    ...
    //basicamente um select * from contactTable where idColumn = [id]
